<?php
    ...
    $eliminarSQL = "DELETE FROM InstanciaCurso WHERE sigla = '$_GET[sigla]'";
...
<head>
  ...
  <link rel="stylesheet" href=<link href="https://maxcdn.bootstrapcdn.com/bootswatch/3.3.7/cerulean/bootstrap.min.css" rel="stylesheet" integrity="sha384-zF4BRsG/fLiTGfR9QL82DrilZxrwgY/+du4p/c7J72zZj+FLYq4zY00RylP9ZjiT" crossorigin ="anonymous">
    <title>Eliminar Instancia</title>
</head>
<body>
    <div>
        <p>La instancia se ha eliminado correctamente en la base de datos</p>
        <button><a href="instancias_curso.php">Regresar al mantenedor de Cursos</a></button>
    </div>
