<?php
    ...
    $actualizarSQL = "UPDATE Curso SET nombre='$_POST[nombre]', descripcion='$_POST[descripcion]' WHERE sigla = '$_GET[sigla]'";
...
<title>Editar Curso</title>
    ...
    <body>
    <div>
        <p>Se han actualizado correctamente los datos del curso en la base de datos</p>
